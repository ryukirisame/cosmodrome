...
// function chooseRoverDate()
// {
//   const rover = document.querySelector('#curiosity_link');
//   const test = document.createElement('div');
//   const date_box = document.createElement('div');
//   const chooseDate = document.createElement('div');
//   date_box.classList.add('date_box');
//   date_box.id = 'date_box';
//   const rover_box = document.createElement('div');
//   rover_box.classList.add('rover_div');
//   rover_box.id = 'rover_div';
//   test.id = "choose_date_for_curiosity"
//   test.classList.add('choose_date_for_curiosity');
//   document.body.appendChild(test);
//   test.appendChild(date_box);
//   test.appendChild(rover_box);
// }
